...
// config/nav.php
// ============================================================
// Fragmento reutilizable: barra de sesión + navegación
// Inclúyelo en TODAS las páginas con: require_once 'config/nav.php';
// ============================================================
require_once __DIR__ . '/sesion.php';

// Definimos la ruta base de tu proyecto en XAMPP
